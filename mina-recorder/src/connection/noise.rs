...
fn noise() {
    ...
    noise.on_data_(true, hex::decode("00209844288f8c8f0337dff411d66e0378d950fb7590f9f44d6df969fd59a18ab849").unwrap(), &mut randomness).unwrap();
    ...
    noise.on_data_(true, hex::decode("00375cd2640426acf52810f89147cf5446f8b4bff334c9727c0a45abd220746b2e8b10d269ff28be87c8bb1d53e43e69922ff4b19760ef875d").unwrap(), &mut randomness).unwrap();
}
